 ...
 * @author Frank
 */
public class frm_InformationCustomer extends javax.swing.JFrame {
     ...
     */
    public frm_InformationCustomer() {
        initComponents();
        user_update = frm_BuscarCliente.user_update;
    ...
    private void initComponents() {
        ...
        txt_ciudad.setForeground(new java.awt.Color(0, 0, 0));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_InformationCustomer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_InformationCustomer().setVisible(true);
            }
        });
    }
