...
public class frm_boletofa extends javax.swing.JFrame {
    ...
    private void cmbMeseroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbMeseroActionPerformed
        ...
        if (cmb==2) {
            frm_BuscarBoleto t =new frm_BuscarBoleto();
            t.setVisible(true);
        }else if (cmb==3) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_boletofa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_boletofa().setVisible(true);
            }
        });
    }
