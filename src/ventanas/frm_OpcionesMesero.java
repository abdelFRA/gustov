...
public class frm_OpcionesMesero extends javax.swing.JFrame {

    /**
     * Creates new form frm_ChooseCustomersOption
     */
    public frm_OpcionesMesero() {
        initComponents();
    ...
    private void initComponents() {
        ...
        cmbMesero = new javax.swing.JComboBox<String>();
    ...
    private void cmbMeseroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbMeseroActionPerformed
        ...
        if (cmb==2) {
            frm_BuscarMesero sw =new frm_BuscarMesero();
            sw.setVisible(true);
        }else if (cmb==3) {
             try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_OpcionesMesero.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_OpcionesMesero().setVisible(true);
            }
        });
    }
