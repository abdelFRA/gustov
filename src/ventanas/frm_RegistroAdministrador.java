 ...
 * @author Frank
 */
public class frm_RegistroAdministrador extends javax.swing.JFrame {

    public frm_RegistroAdministrador() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_RegistroAdministrador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_RegistroAdministrador().setVisible(true);
            }
        });
    }
