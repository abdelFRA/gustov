 ...
 * @author Frank
 */
public class frm_BuscarBoleto extends javax.swing.JFrame {

    /**
     * Creates new form frm_SearchVoucher
     */
    public frm_BuscarBoleto() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_BuscarBoleto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_BuscarBoleto().setVisible(true);
            }
        });
    }
