...
public class frm_OpcionesAdministrador extends javax.swing.JFrame {

    /**
     * Creates new form frm_ChooseAdministratorOption
     */
    public frm_OpcionesAdministrador() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_OpcionesAdministrador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_OpcionesAdministrador().setVisible(true);
            }
        });
    }
