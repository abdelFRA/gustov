 ...
 * @author Frank
 */
public class frm_RegistroEmpleado extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cmb_numerodeMesero = new javax.swing.JComboBox<String>();
        ...
        jLabel_Wallpaper.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/fondo 3.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_RegistroEmpleado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_RegistroEmpleado().setVisible(true);
            }
        });
    }
