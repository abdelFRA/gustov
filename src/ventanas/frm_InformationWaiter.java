 ...
 * @author Frank
 */
public class frm_InformationWaiter extends javax.swing.JFrame {
String user_update = "";
    int ID;
    /**
     * Creates new form frm_InformationWaiter
     */
    public frm_InformationWaiter() {
        initComponents();
        user_update = frm_BuscarMesero.user_update;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_InformationWaiter.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_InformationWaiter().setVisible(true);
            }
        });
    }
