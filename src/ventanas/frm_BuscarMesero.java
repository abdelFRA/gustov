...
import static ventanas.frm_BuscarAdministrador.user_update;

/**
 *
 * @author Frank
 */
public class frm_BuscarMesero extends javax.swing.JFrame {
    
  public static String user_update = "";
    /**
     * Creates new form frm_SearchWaiter
     */
    public frm_BuscarMesero() {
        initComponents();
        ...
        tablaMeseros.addMouseListener(new MouseAdapter(){
            ...
            public void mouseClicked(MouseEvent e){
                ...
                if (fila_point > -1) {
                    ...
                    frm_InformationWaiter me = new frm_InformationWaiter();
                    me.setVisible(true);
                }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_BuscarMesero.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_BuscarMesero().setVisible(true);
            }
        });
    }
